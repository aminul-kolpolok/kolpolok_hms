...
class EmergencyAdmissionInfo(models.Model):
    ...
    # --------------------- Payment Relation
    emergency_admission_payment_line_id = fields.One2many('emergency.admission.payment.line', 'payment_item_id')
    # --------------------- Journal Relation
    emergency_admission_journal_relation_line_id = fields.One2many('emergency.admission.journal.line', 'admission_journal_item_id')
    ...
    def btn_action_report(self):
        pass
    def btn_add_test(self):
        pass
    def btn_add_discount(self):
        pass
    def btn_customer_settlement(self):
        pass
    def btn_customer_payment(self):
        pass
...
class EmergencyAdmissionAdmissionPaymentLineId(models.Model):
    _name = 'emergency.admission.payment.line'
...
class EmergencyAdmissionJournalRelationLineId(models.Model):
    _name = 'emergency.admission.journal.line'
